<?php 
	...
	$params = array(
    	'oauth_callback' => rawurldecode('http://wordo.co/services/loginCallback.php?redirect_to='.$_SERVER['HTTP_REFERER'])
    	// 'oauth_callback' => rawurldecode('http://wordo.co/services/loginCallback.php')
	);
