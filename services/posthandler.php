<?php 
    ...
    if (!($_SERVER['REQUEST_METHOD'] === 'POST')) {
        ...
        if ($action === 'whoElseLiked') {
            ...
            $sql = "select u.screen_name as screen_name,DATE_FORMAT(uw.row_created_date,'%Y-%m-%dT%TZ-0400') as word_liked_time_ISO8601
            ...
            if ($whoElseLiked_rows->rowCount()) {
                echo '<b>'.$whoElseLiked_rows->rowCount().' Like'.($whoElseLiked_rows->rowCount()==1?'':'s').'</b>';
